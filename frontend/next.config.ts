...
// Load root .env.example so FRONTEND_URL / BACKEND_URL / NEXT_PUBLIC_* are in one place (repo root)
...
const nextConfig: NextConfig = {
    env: {
        // Prefer root .env.example BACKEND_URL so frontend and backend stay in sync
