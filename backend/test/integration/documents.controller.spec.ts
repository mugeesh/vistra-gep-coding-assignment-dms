...
describe('DocumentsController (integration)', () => {
    ...
    // documents.controller.spec.ts (partial - focus on failing parts)
    ...
    describe('POST /documents', () => {
        ...
        it('should create document at root level (folderId null)', async () => {
            ...
            jest.spyOn(documentsService, 'createDocument').mockResolvedValue(mockCreated);
        ...
        it('should return 400 for invalid folderId (negative)', async () => {
            ...
            expect(response.body.message).toContain('folderId must be ≥ 1');
        });
    });
});
